...
const DefaultButton: React.FC<ButtonProps> = ({ content, props, href }) => {
  return (
    <a
      href={href}
      download  
    ...
    <div className="m-auto w-full p-[24px] flex flex-row justify-center lg:max-w-[1920px] lg:justify-between lg:text-left lg:px-[150px] lg:items-center">
      <div className="flex flex-col gap-[40px] text-center ">
        ...
        <div className="w-full flex justify-center gap-[9px] lg:justify-start">
          ...
          ></DefaultButton>
          <DefaultButton
            href="mailto:thyago.monnerat.pro@gmail.com"
            content="Entrar em contato"
            props="text-white border border-1 border-solid border-color-button transition-border duration-[.3s] ease hover:border-white"
          ></DefaultButton>
        </div>
      </div>
